...
export const Crew = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: Crew): void {
    __AlgebraicTypeValue.serializeValue(writer, Crew.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Crew {
    return __AlgebraicTypeValue.deserializeValue(reader, Crew.getTypeScriptAlgebraicType());
  },
