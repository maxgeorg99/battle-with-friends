...
export const PlayerItem = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: PlayerItem): void {
    __AlgebraicTypeValue.serializeValue(writer, PlayerItem.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): PlayerItem {
    return __AlgebraicTypeValue.deserializeValue(reader, PlayerItem.getTypeScriptAlgebraicType());
  },
